                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-16">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <span className="font-bold text-xl text-gray-800">Melodi POS</span>
                        </div>
                        ...
                        <div className="flex items-center gap-6">
                            <div className="hidden sm:flex items-center gap-6 text-sm font-medium text-gray-600">
                                ...
                                <Link href="#" className="hover:text-emerald-600 transition-colors">Produk</Link>
                            </div>

                            <div className="flex items-center gap-4">
                                {/* Cart Icon */}
                                <Link href="#" className="relative text-gray-600 hover:text-emerald-600 transition-colors">
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="bg-emerald-50 rounded-3xl p-8 sm:p-12 mb-12 relative overflow-hidden flex items-center min-h-[360px]">
                    <div className="relative z-10 max-w-xl">
                        ...
                        <div className="flex flex-wrap gap-4">
                            <button className="bg-emerald-500 hover:bg-emerald-600 text-white font-semibold py-3 px-6 rounded-full transition-colors flex items-center gap-2 shadow-md shadow-emerald-500/20">
                                Belanja Sekarang
                                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M14 5l7 7m0 0l-7 7m7-7H3" /></svg>
                            </button>
                            <button className="bg-white hover:bg-gray-50 text-gray-800 font-semibold py-3 px-6 rounded-full transition-colors shadow-sm border border-gray-200">
                                Lihat Katalog
                            </button>
                        </div>
                    </div>
                ...
                <div className="mb-12">
                    <div className="flex justify-between items-end mb-6">
                        ...
                        <Link href="#" className="text-emerald-600 text-sm font-semibold hover:underline">Lihat Semua</Link>
                    </div>
                    
                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-4">
                        {categories?.map((cat) => (
                            <Link key={cat.category_id} href="#" className="bg-white rounded-2xl p-5 text-center shadow-sm border border-gray-100 hover:border-emerald-200 hover:shadow-md transition-all group">
                ...
                <div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        {products?.map((product) => (
                            <div key={product.product_id} className="bg-white rounded-3xl p-4 shadow-sm border border-gray-100 hover:shadow-lg hover:border-emerald-200 transition-all group flex flex-col h-full">
                                <div className="aspect-square bg-gray-50 rounded-2xl mb-4 overflow-hidden relative">
                                    {/* Placeholder image related to music using unsplash source based on product name if possible, otherwise generic music */}
                                    <img 
                                    ...
                                    <div className="mt-auto pt-2">
                                        ...
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-center text-xs text-gray-500 gap-1">
                                                ...
                                                <span className="font-semibold text-gray-700">4.{product.product_id % 9 + 1}</span>
                                                <span>•</span>
                                                <span>{product.product_id * 12} Terjual</span>
                                            </div>
